...
export default function ContactPageContent() {
  ...
  const validateField = (fieldName: keyof FormData, value: string): string => {
    switch (fieldName) {
      ...
      case 'message': {
        const trimmed = value.trim();
        if (!trimmed) return 'Please tell us a bit about your event.';
  ...
  const handleChange = (
    ...
    // Live-clear/update the error for this field as the user types
    setErrors((prev) => ({
      ...prev,
  ...
  const inputClasses = (fieldName: keyof FormData) =>
    `w-full bg-muted border px-4 py-3 text-sm text-foreground placeholder-muted-foreground focus:outline-none transition-colors duration-200 ${
      errors[fieldName]
              ...
              {[
                {
                  ...
                  label: 'Email',
                  value: 'Akinodekorede3@gmail.com',
                  href: "https://mail.google.com/mail/?view=cm&fs=1&to=Akinodekorede3@gmail.com",
                },
                {
                  icon: (
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                {[
                  {
                    label: 'YouTube',
                    href: 'https://youtube.com/@violinist_ak3?si=c1NO5EDllcx4JA8-',
                    icon: (
                  ...
                  {
                    label: 'TikTok',
                    href: 'https://www.tiktok.com/@violinistak3?_r=1&_t=ZS-9997qRCpzSH',
                    icon: (
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {
                    label: 'Instagram',
                    href: 'https://www.instagram.com/violinist_ak3?igsi=MXgxMGg4MWw1dnB0Yg%3D%3D&utm_source=qr',
                    icon: (
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  {
                    label: 'Facebook',
                    href: 'https://www.facebook.com/share/19fU3YQrYb/?mibextid=wwXIfr',
                    icon: (
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`${inputClasses('eventType')} appearance-none`}
                  >
                  ...
                  {errors.eventType && (
                    <p id="eventType-error" className="mt-1.5 text-xs text-red-500">
                      {errors.eventType}
                    </p>
                  )}
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-accent text-accent-foreground font-bold text-sm tracking-widest uppercase hover:bg-secondary hover:text-background transition-all duration-300 group disabled:opacity-50 disabled:cursor-not-allowed"
                >
